...
public class AboutDialog extends JDialog {
	...
	private void initComponents() {
		...
		xheader.setTitle(
				"<html><body><b>" + I18n.COMPONENT.getString("AboutDialog.Header.Title") + "</b></body></html>");
		xheader.setDescription(I18n.COMPONENT.getString("AboutDialog.Header.Description"));
		xheader.setFont(new Font("Tahoma", 0, 12));
		xheader.setIcon(new ImageIcon(getClass().getResource(ViewHelpers.ICONS22 + "about.png")));
	...
	private JPanel buildCenterPanel() {
		...
		JLabel lblIcons = new JLabel(I18n.OPTIMIZED.getString("App.Icons"));
	...
	private void buildActions() {
		acBlog = new AbstractAction("http://www.enuminfo.com") {
			@Override
			public void actionPerformed(ActionEvent e) {
				ViewHelpers.browseUrl("http://www.enuminfo.com");
			}
		};
	...
	public static void showDialog() {
		AboutDialog aboutDialog = new AboutDialog(AppController.get().getView());
